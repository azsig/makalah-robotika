...
\begin{itemize}
    ...
    \item \textbf{Correction Factor:} A calibration factor is loaded from the external file \texttt{faktor\_koreksi.txt} to scale the distance ($s_{\text{calibrated}} = s_{\text{raw}} \times f_{\text{correction}}$).
